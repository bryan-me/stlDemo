...
import 'package:stldemo/login_page.dart';
import 'package:stldemo/models/api_response.dart';
import 'package:stldemo/services/rest_api_service.dart';
...
class UserHomePage extends StatefulWidget {
  UserHomePage({required Key key, this.username}) : super(key: key);
...
class _UserHomePageState extends State<UserHomePage> {
  ...
  void _updateState(ApiResponse<ServerMessage> response) {
    if (response.code == 200) {
      ...
      _updateServerMessage(ServerMessage(message: requestFailedMsg));
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            Padding(
              ...
              child: Text("Username: ${widget.username ?? 'Guest'}"),
            ),
            Padding(
